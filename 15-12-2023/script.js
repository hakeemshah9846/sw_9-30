...
let dateStrReplaced = dateStr.replace(/(\d{2})$/,'20$1');//gets '04' from dateStr and replace it as '2004', $1 will get the value of the first capture group ie within '()' brackets.
